...
class Crypton(object):
	...
	def GetDictCrypton(self):
		...
		dict_crypt={
		  ...
		  "b_miner": CryptonObj("-xf","bminer","bminer","1.52a","bminer-v16.4.11-2849b5c-amd64.tar.gz"),
		  "srb_miner": CryptonObj("-xf","srbminer","srbminer","1.52a","SRBMiner-Multi-1-0-2-Linux.tar.gz"),
		  "nb_miner": CryptonObj("-xzf","nbminer","nbminer","1.52a","NBMiner_42.2_Linux.tar.gz"),
		  "teamred_miner": CryptonObj("-xzf","teamredminer","1.52a","teamredminer","teamredminer-v0.10.2-linux.tar.gz"),
		  "t_rex_miner": CryptonObj("-xzvf","t-rex","t_rex","1.52a","t-rex-0.26.4-linux.tar.gz"),
		  "g_miner": CryptonObj("-xf","miner","gminer","1.52a","gminer_3_03_linux64.tar.gz")
		}
		return dict_crypt
